...
<body>
	...
	<div><div id="status" style="float: right;margin-top: 20px;position: fixed;margin-left: 865px;font-size: smaller;color: white;"></div>
			<span><img id="user_profile_pic"  src=""  height="30" width="30" style=" display :none;  border-radius: 10px;float: right;margin-top: 16px;margin-left: 944px;position: fixed;width: 30px;height: 30px;border-radius: 50%;font-size: 50px;color: #fff;line-height: 500px;text-align: center;background: #000;"></span>
  				<span id="user_profile_name" style="display: none;border-radius: 10px;float: right;margin-top:1.3%;width: 30px;height: 27px;margin-left: 76.2%;background-color: #323D8E;position: fixed;"><span id="pic_value" style="color:white;margin-left: 10px;font-size: large;"></span></span></span></div>
